...
function testData1Columns (){
  ...
  var c = [
    ...
    new pear.data.Column("Unit Price",'up','unitprice',75,pear.data.Column.DataType.NUMBER),
    new pear.data.Column("Quantity",'quantity','quantity',75,pear.data.Column.DataType.NUMBER,pear.data.Column.Align.RIGHT),
    new pear.data.Column("Total",'total','total',75,pear.data.Column.DataType.NUMBER),
    new pear.data.Column("Created On",'createdon','created',95,pear.data.Column.DataType.DATETIME),
