...
/**
 * Whether Mediator is Active - if a gridcell is hosting a editor , in open state
 * then Mediator is suppose to be active
 * @return {boolean} 
 */
...
pear.ui.editor.CellEditorMediator.prototype.commit = function (){
  ...
  var newrowdata = goog.object.unsafeClone(oldrowdata);
 ...
 */
pear.ui.editor.CellEditorMediator.prototype.ActivateCellEditor = function (gridcell){
