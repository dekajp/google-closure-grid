 ...
 * @private
 */
pear.ui.editor.EditorBase.prototype.removeContent = function() {
 ...
 * @private
 */
pear.ui.editor.EditorBase.prototype.validateInternal = function(oldrowdata,newrowdata) {
  if(this.validateFn){
...
/**
 * handleMouseEvent
 * {goog.events.BrowserEvent} be Key event to handle.
 * @private
 */
